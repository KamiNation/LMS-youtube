...
// second file in admin folder used in dashboardhero to display themeswitcher and bell icon
                    ...
                    <div className='w-[350px] h-[50vh] dark:bg-[#111C43] bg-white shadow-xl absolute top-16 z-10 rounded'>
                        ...
                        <div className='dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#0000000f]'>
                            ...
                            <p className='px-2 text-black dark:text-white cursor-pointer'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam, fugiat tempora necessitatibus perspiciatis impedit non. Inventore corrupti ad incidunt laboriosam possimus molestias facilis illum, obcaecati earum. Iste non animi laborum.
                            </p>
